...
- (void)viewDidLoad {
    ...
    self.urlArray = @[@"http://sbslive.cnrmobile.com/storage/storage2/18/01/18/46eeb50b3f21325a6f4bd0e8ba4d2357.3gp",
                      @"http://sbslive.cnrmobile.com/storage/storage2/51/34/18/3e59db9bb51802c2ef7034793296b724.3gp",
                      @"http://sbslive.cnrmobile.com/storage/storage2/05/61/05/f2609b3b964bbbcfb3e3703dde59a994.3gp",
                      @"http://sbslive.cnrmobile.com/storage/storage2/28/11/28/689f8a52fbef0fbbf51db19ee3276ae5.3gp",
...
- (void)downloaderState:(ZYLDownloaderState)state andDownloaderUrl:(NSString *)downloaderUrl {
    NSLog(@"下载器%@的状态%lu", downloaderUrl, (unsigned long)state);
}

- (void)downloaderFinishedWithDownloader:(NSString *)downloaderUrl
{
    NSLog(@"任务%@下载完成", downloaderUrl);
}
